...
export default function LandingPage() {
  const t = useTranslations("LandingPage"); // Access "LandingPage" namespace
  const tFeatures = useTranslations("LandingPage.features"); // For nested features

  const features = tFeatures.raw("items").map((item: { title: string; description: string }, index: number) => ({
    title: item.title,
    description: item.description,
    icon: ["📅", "⏰", "🔄"][index], // Keep icons as they were
  }));
